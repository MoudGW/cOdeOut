      ...
      if(data[i].name==undefined)
       ...
       if(state=='offline')
       {
        var html="<div class='col-sm-4 text-center classy'><img class='photos offline' src="+img+"/><div class='centred'>"+state+"</div></div>"
         ...
         var html="<div class='col-sm-4 text-center><div class='col-sm-4 text-center'><img class='photos' src="+img+"><div class='centred'>"+state+"</div></div><button id='Submit' type='button' class='btn btn-success'>Connect</button></div>";
       }
       $('#users').append(html);
       }
       }
